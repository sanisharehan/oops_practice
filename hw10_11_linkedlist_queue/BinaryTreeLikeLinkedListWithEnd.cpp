//
// Homework#10 (b): Implement a tree as a linked list. A linked list is similar to a tree except that 
...
template <typename T>
class BinaryTreeLikeLinkedListWithEnd {
private:
	Node<T> *root;
	Node<T> *end;
...
public:
	BinaryTreeLikeLinkedListWithEnd() {
		root = NULL;
		end = NULL;
	}
...
int main(int argc, char *argv[]) {
	BinaryTreeLikeLinkedListWithEnd<int> newTree;
